...
- Implemented a CPU scheduling simulator in C++ covering classical and modern algorithms like FCFS,  RR,  SPN,  SRT,  HRRN,  FB-1,  FB-2i,  Aging,  CFS, and  EDF.
- Parsed input, executed scheduling logic, and visualized timelines with process metrics like turnaround time.
– Utilized data structures such as queues and priority queues for efficient process management.
– Developed a modular, well-documented tool to compare scheduling strategies.
